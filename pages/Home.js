      ...
      <div>
        ...
        >
          ...
          <Row gutter={24}>
            ...
            <Col span={12}>
              <Image width={350} src="certificate4.jpg" />
            </Col>
          </Row>
        </div>
        ...
        >
          <div style={{ paddingBottom: '60px', marginLeft: '80px' }}>
            <h style={{ font: '28px proximanova-bold', color: '#444444', paddingTop: '20px', marginLeft: '400px' }}><b>Why we learn digital marketing</b></h></div>
        ...
        <div>
          <div style={{ marginLeft: "430px", marginTop: "50px" }}>
            <div style={{ margintop: '90px' }}>
              <Text style={{ marginLeft: "90px", font: '28px proximanova-bold', color: '#444444', marginBottom: '50px' }} level={2}>
                <b>What projects will you build?</b>
              </Text></div>
          </div>

          <Carousel arrows {...settings1} style={{ marginTop: '80px' }}>
            <div style={{ marginTop: '90px' }}>
                ...
                <Row gutter={16}>
                  <Col span={8}>
                    ...
                    <div>
                      ...
                      >
                        Select the keywords, write the content, and set up a Google Ads campaign to generate online sales for a brand
                  ...
                  <Col span={8}>
                    ...
                    <div>
                      ...
                      >
                        Promote your app using the Universal App Campaign
